...
public interface ILocalTool
{
    ...
    ///
    /// Der groesste Radius aller Werkzeuge bestimmt die Weichzeichnung, die einmal
    /// fuer alle gerechnet wird. Zwei Werkzeuge mit verschiedenem Radius bekaemen
    /// sonst zwei Puffer, und der zweite kostete so viel wie der erste.
    /// </summary>
    int Radius { get; }
